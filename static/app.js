      ...
      return [
        {
          ...
          delta: s.net_deposits
            ? `${s.portfolio_value >= s.net_deposits ? '+' : ''}${fmt(s.portfolio_value - s.net_deposits)} vs deposits`
            : '',
